...
public class FunctionStepDefs {
    ...
    public void user_calls_all_functions_with_extra_data() {
        ...
        String command = "("
                + String.format("echo '{\"run\":\"get_me\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(MAX_EXTRA_DATA_SIZE_IN_BYTES))
                + String.format("echo '{\"run\":\"get_account\",\"address\":\"0001-00000000-XXXX\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"get_accounts\",\"node\":\"1\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"get_block\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"get_blocks\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"get_broadcast\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"get_log\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"get_message\", \"message_id\":\"0001:00000001\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"get_message_list\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"get_transaction\", \"txid\":\"0001:00000001:0001\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"get_signatures\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"get_vipkeys\", \"viphash\":\"%s\", \"extra_data\":\"%s\"}';", vipHash, EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"decode_raw\", \"data\":\"0301000000000001000000A1679B5B010000\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"create_account\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"create_node\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"log_account\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"retrieve_funds\",\"address\":\"0002-00000000-XXXX\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"change_account_key\",\"public_key\":\"%s\",\"confirm\":\"%s\", \"extra_data\":\"%s\"}';", userPublicKey, userEmptyStringSignature, EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"change_node_key\",\"public_key\":\"%s\", \"extra_data\":\"%s\"}';", nodePublicKey, EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"send_one\",\"address\":\"0001-00000000-XXXX\",\"amount\":\"1\", \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"send_many\",\"wires\":{\"0001-00000000-XXXX\":\"1\", \"0002-00000000-XXXX\":\"1\"}, \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"set_account_status\",\"address\":\"0001-00000000-XXXX\",\"status\":16, \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"unset_account_status\",\"address\":\"0001-00000000-XXXX\",\"status\":16, \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"set_node_status\",\"node\":1,\"status\":16, \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + String.format("echo '{\"run\":\"unset_node_status\",\"node\":1,\"status\":16, \"extra_data\":\"%s\"}';", EscUtils.generateHexMessage(random.nextInt(MAX_EXTRA_DATA_SIZE_IN_BYTES + 1)))
                + "echo '{\"run\":\"get_me\"}')";
